...
with open('results/wtr_full_run/results.csv', 'w', encoding='utf8', newline='') as output_file:
    ...
    with open('results/wtr_full_run/results.jsonl', 'r', encoding='utf8') as input_file:
